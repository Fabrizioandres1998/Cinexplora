...
import SliderThriller from './SliderThriller'



const Thriller = () => {
    const [peliculasThriller, setPeliculasThriller] = useState([])
    ...
    useEffect(() => {
        ...
        const fetchAllPages = async () => {
            ...
            setPeliculasThriller(allResults)
        }
    ...
    return (
        <>
            <h1>Thriller</h1>
            <SliderThriller peliculasThriller={peliculasThriller} />
        </>
    )
}
