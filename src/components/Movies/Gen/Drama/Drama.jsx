...
import SliderDrama from './SliderDrama'
...
const Drama = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async (page) => {
            const URLtmdb = `${APIurl}?api_key=${APIkey}&language=es-US&sort_by=popularity.desc&page=${page}&with_genres=${18}`
            try {
    ...
    return (
        <>
            <h1>Drama</h1>
            <SliderDrama peliculasDrama={peliculasDrama} />
        </>
    )
}
